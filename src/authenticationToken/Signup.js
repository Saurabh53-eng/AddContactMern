        ...
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" className="form-control" value={credentials.password} onChange={onChange} autoComplete="on" name="password" id="password" />
                </div>
                <div className="mb-3">
                    <label htmlFor="cpassword" className="form-label">Confirm Password</label>
                    <input type="password" className="form-control" value={credentials.cpassword} onChange={onChange} autoComplete="on" name="cpassword" id="cpassword" />
                </div>
